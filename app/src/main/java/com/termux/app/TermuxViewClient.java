...
public final class TermuxViewClient implements TerminalViewClient {
    ...
    public void onSingleTapUp(MotionEvent e) {
        InputMethodManager mgr = (InputMethodManager) mActivity.activity.getSystemService(Context.INPUT_METHOD_SERVICE);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent e, TerminalSession currentSession) {
        ...
        if (keyCode == KeyEvent.KEYCODE_ENTER && !currentSession.isRunning()) {
            ...
            if (keyCode == KeyEvent.KEYCODE_DPAD_DOWN || unicodeChar == 'n'/* next */) {
                ...
                InputMethodManager imm = (InputMethodManager) mActivity.activity.getSystemService(Context.INPUT_METHOD_SERVICE);
        ...
        if (mVirtualFnKeyDown) {
            ...
            switch (lowerCase) {
                ...
                case 'v':
                    ...
                    AudioManager audio = (AudioManager) mActivity.activity.getSystemService(Context.AUDIO_SERVICE);
